  ...
  const skillCategories = [
    {
      ...
      skills: ['C', 'C++', 'Java', 'Python', 'JavaScript', 'PHP', 'SQL', 'TypeScript']
    },
    {
      title: 'Web Technologies',
      icon: Globe,
      color: 'from-blue-500 to-violet-600',
      skills: ['HTML', 'CSS', 'React.js', 'Node.js', 'Express.js', 'REST APIs', 'Socket.io']
    },
    {
      title: 'Database Management',
      icon: Database,
      color: 'from-violet-500 to-purple-600',
      skills: ['MongoDB', 'MySQL', 'DBMS', 'Redis', 'Database Design', 'Query Optimization']
    },
    {
      title: 'Cloud & DevOps',
      icon: Cloud,
      color: 'from-green-500 to-emerald-600',
      skills: ['AWS EC2', 'S3', 'Lambda', 'RDS', 'IAM', 'VPC', 'CloudWatch', 'Git', 'GitHub', 'Postman']
    },
    {
      title: 'Software Development',
      icon: Wrench,
      color: 'from-orange-500 to-red-600',
      skills: ['Data Structures', 'Algorithms', 'OOP', 'System Design', 'SDLC', 'Agile']
    },
    {
      title: 'Security & Networking',
      icon: Shield,
      color: 'from-red-500 to-pink-600',
      skills: ['JWT', 'Authentication', 'TCP/IP', 'Network Security', 'RBAC']
    }
  ];
    ...
    <section id="skills" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 bg-gradient-to-r from-cyan-500/10 to-blue-600/10 rounded-xl p-8 border border-cyan-500/20">
          <h3 className="text-2xl font-bold mb-6 text-center text-cyan-400">Additional Expertise</h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="text-lg font-semibold text-slate-300 mb-3">Development Practices</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold text-slate-300 mb-3">Systems Knowledge</h4>
              <ul className="space-y-2 text-slate-400">
                <li className="flex gap-2">
                  <span className="text-cyan-400">•</span>
